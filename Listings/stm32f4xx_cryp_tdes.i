#line 1 "STM_Lib\\src\\stm32f4xx_cryp_tdes.c"
...
#line 49 "STM_Lib\\src\\stm32f4xx_cryp_tdes.c"
                          ...
                          uint32_t Ilength, uint8_t *Output)
{
  ...
  {
     TDES_CRYP_InitStructure.CRYP_AlgoDir = ((uint16_t)0x0000);
  }
  else    
  {
     TDES_CRYP_InitStructure.CRYP_AlgoDir = ((uint16_t)0x0004);
  }

  TDES_CRYP_InitStructure.CRYP_AlgoMode = ((uint32_t)0x00000000);
  TDES_CRYP_InitStructure.CRYP_DataType = ((uint16_t)0x0080);
                          ...
                          uint8_t *Input, uint32_t Ilength, uint8_t *Output)
{
  ...
  TDES_CRYP_InitStructure.CRYP_AlgoMode = ((uint32_t)0x00000008);
  TDES_CRYP_InitStructure.CRYP_DataType = ((uint16_t)0x0080);
