#line 1 "STM_Lib\\src\\stm32f4xx_syscfg.c"
...
#line 341 ".\\STM_Lib\\inc\\stm32f4xx_syscfg.h"
...
#line 51 "STM_Lib\\src\\stm32f4xx_syscfg.c"
#line 52 "STM_Lib\\src\\stm32f4xx_syscfg.c"
...
void SYSCFG_MemoryRemapConfig(uint8_t SYSCFG_MemoryRemap)
{
  ...
  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3800))->MEMRMP = SYSCFG_MemoryRemap;
}
...
void SYSCFG_MemorySwappingBank(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x00010000) + 0x3800) - ((uint32_t)0x40000000)) * 32) + (((uint8_t)0x8) * 4)) = (uint32_t)NewState;
}
...
void SYSCFG_EXTILineConfig(uint8_t EXTI_PortSourceGPIOx, uint8_t EXTI_PinSourcex)
{
  ...
  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3800))->EXTICR[EXTI_PinSourcex >> 0x02] &= ~tmp;
  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3800))->EXTICR[EXTI_PinSourcex >> 0x02] |= (((uint32_t)EXTI_PortSourceGPIOx) << (0x04 * (EXTI_PinSourcex & (uint8_t)0x03)));
}
...
{ 
  ...
  *(volatile uint32_t *) (((uint32_t)0x42000000) + (((((((uint32_t)0x40000000) + 0x00010000) + 0x3800) - ((uint32_t)0x40000000)) + 0x04) * 32) + (((uint8_t)0x17) * 4)) = SYSCFG_ETH_MediaInterface; 
}
...
void SYSCFG_CompensationCellCmd(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) (((uint32_t)0x42000000) + (((((((uint32_t)0x40000000) + 0x00010000) + 0x3800) - ((uint32_t)0x40000000)) + 0x20) * 32) + (((uint8_t)0x00) * 4)) = (uint32_t)NewState;
}
...
FlagStatus SYSCFG_GetCompensationCellStatus(void)
{
  ...
  if ((((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3800))->CMPCR & ((uint32_t)0x00000100) ) != (uint32_t)RESET)
  {
    bitstatus = SET;
  }
  else
...
#line 253 "STM_Lib\\src\\stm32f4xx_syscfg.c"

#line 509 "STM_Lib\\src\\stm32f4xx_syscfg.c"
