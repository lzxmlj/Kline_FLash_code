#line 1 "STM_Lib\\src\\stm32f4xx_rng.c"
...
#line 112 ".\\STM_Lib\\inc\\stm32f4xx_rng.h"
...
#line 57 "STM_Lib\\src\\stm32f4xx_rng.c"
#line 58 "STM_Lib\\src\\stm32f4xx_rng.c"
...
void RNG_DeInit(void)
{
  ...
  RCC_AHB2PeriphResetCmd(((uint32_t)0x00000040), ENABLE);

   
  RCC_AHB2PeriphResetCmd(((uint32_t)0x00000040), DISABLE);
#line 115 "STM_Lib\\src\\stm32f4xx_rng.c"
}
...
uint32_t RNG_GetRandomNumber(void)
{
  ...
  return ((RNG_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x60800))->DR;
}
...
FlagStatus RNG_GetFlagStatus(uint8_t RNG_FLAG)
{
  ...
  if ((((RNG_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x60800))->SR & RNG_FLAG) != (uint8_t)RESET)
  {
...
void RNG_ClearFlag(uint8_t RNG_FLAG)
{
  ...
  ((RNG_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x60800))->SR = ~(uint32_t)(((uint32_t)RNG_FLAG) << 4);
}
...
ITStatus RNG_GetITStatus(uint8_t RNG_IT)
{
  ...
  if ((((RNG_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x60800))->SR & RNG_IT) != (uint8_t)RESET)
  {
...
void RNG_ClearITPendingBit(uint8_t RNG_IT)
{
  ...
  ((RNG_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x60800))->SR = (uint8_t)~RNG_IT;
}
