...
#line 5 "BoardHardware\\SPI1.h"
#line 6 "BoardHardware\\SPI1.h"
void SPI1_Init(void);
...
#line 42 "BoardHardware\\SPI1.c"
}

void SPI1_SetSpeed(u8 SpeedSet)
{
	((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000))->CR1&=0XFFC7;
	((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000))->CR1|=SpeedSet;
	SPI_Cmd(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)),ENABLE);
}
u8 SPI1_ReadWriteByte(u8 TxData)
{
	u8 retry=0;
	while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)), ((uint16_t)0x0002)) == RESET) 
	{
		retry++;
		if(retry>200)return 0;
	}
	SPI_I2S_SendData(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)), TxData); 
	retry=0;

	while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)), ((uint16_t)0x0001)) == RESET) 
	{
		retry++;
		if(retry>200)return 0;
	}
...
__weak void SPI1_CS1Pin_Init(void)
{
	...
	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), ((uint16_t)0x0020));
}
