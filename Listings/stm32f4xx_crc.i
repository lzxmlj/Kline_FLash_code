...
#line 74 ".\\STM_Lib\\inc\\stm32f4xx_crc.h"
...
#line 30 "STM_Lib\\src\\stm32f4xx_crc.c"
...
void CRC_ResetDR(void)
{
  ...
  ((CRC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3000))->CR = ((uint8_t)0x01);
}
...
uint32_t CRC_CalcCRC(uint32_t Data)
{
  ((CRC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3000))->DR = Data;
  
  return (((CRC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3000))->DR);
}
...
uint32_t CRC_CalcBlockCRC(uint32_t pBuffer[], uint32_t BufferLength)
{
  ...
  {
    ((CRC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3000))->DR = pBuffer[index];
  }
  return (((CRC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3000))->DR);
}
...
void CRC_SetIDRegister(uint8_t IDValue)
{
  ((CRC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3000))->IDR = IDValue;
}
...
uint8_t CRC_GetIDRegister(void)
{
  return (((CRC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3000))->IDR);
}
