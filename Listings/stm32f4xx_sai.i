#line 1 "STM_Lib\\src\\stm32f4xx_sai.c"
...
#line 1 ".\\STM_Lib\\inc\\stm32f4xx_sai.h"
...
#line 39 ".\\STM_Lib\\inc\\stm32f4xx_sai.h"
...
#line 172 ".\\STM_Lib\\inc\\stm32f4xx_sai.h"
...
#line 192 ".\\STM_Lib\\inc\\stm32f4xx_sai.h"
...
#line 206 ".\\STM_Lib\\inc\\stm32f4xx_sai.h"
...
#line 226 ".\\STM_Lib\\inc\\stm32f4xx_sai.h"
...
#line 264 ".\\STM_Lib\\inc\\stm32f4xx_sai.h"
...
#line 277 ".\\STM_Lib\\inc\\stm32f4xx_sai.h"
...
#line 389 ".\\STM_Lib\\inc\\stm32f4xx_sai.h"
...
#line 424 ".\\STM_Lib\\inc\\stm32f4xx_sai.h"
...
#line 469 ".\\STM_Lib\\inc\\stm32f4xx_sai.h"
...
#line 487 ".\\STM_Lib\\inc\\stm32f4xx_sai.h"
...
#line 524 ".\\STM_Lib\\inc\\stm32f4xx_sai.h"

#line 532 ".\\STM_Lib\\inc\\stm32f4xx_sai.h"
...
#line 547 ".\\STM_Lib\\inc\\stm32f4xx_sai.h"

#line 555 ".\\STM_Lib\\inc\\stm32f4xx_sai.h"
                                   
#line 563 ".\\STM_Lib\\inc\\stm32f4xx_sai.h"
...
#line 576 ".\\STM_Lib\\inc\\stm32f4xx_sai.h"

#line 583 ".\\STM_Lib\\inc\\stm32f4xx_sai.h"
...
#line 127 "STM_Lib\\src\\stm32f4xx_sai.c"
#line 128 "STM_Lib\\src\\stm32f4xx_sai.c"
...
void SAI_DeInit(SAI_TypeDef* SAIx)
{
  ...
  if(SAIx == ((SAI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x5800)))
  {
     
    RCC_APB2PeriphResetCmd(((uint32_t)0x00400000), ENABLE);
     
    RCC_APB2PeriphResetCmd(((uint32_t)0x00400000), DISABLE); 
  }
  else
  {
#line 208 "STM_Lib\\src\\stm32f4xx_sai.c"
  }
}
...
void SAI_StructInit(SAI_InitTypeDef* SAI_InitStruct)
{
  ...
  SAI_InitStruct->SAI_AudioMode = ((uint32_t)0x00000000);
   
  SAI_InitStruct->SAI_Protocol = ((uint32_t)0x00000000);
   
  SAI_InitStruct->SAI_DataSize = ((uint32_t)0x00000040);
   
  SAI_InitStruct->SAI_FirstBit = ((uint32_t)0x00000000);
   
  SAI_InitStruct->SAI_ClockStrobing = ((uint32_t)0x00000000);
   
  SAI_InitStruct->SAI_Synchro = ((uint32_t)0x00000000);
     
  SAI_InitStruct->SAI_SynchroExt = ((uint32_t)0x00000000);
   
  SAI_InitStruct->SAI_OUTDRIV = ((uint32_t)0x00000000);
   
  SAI_InitStruct->SAI_NoDivider = ((uint32_t)0x00000000);
   
  SAI_InitStruct->SAI_MasterDivider = 0;
   
  SAI_InitStruct->SAI_FIFOThreshold = ((uint32_t)0x00000000);
}
...
void SAI_FrameStructInit(SAI_FrameInitTypeDef* SAI_FrameInitStruct)
{
  ...
  SAI_FrameInitStruct->SAI_FSDefinition = ((uint32_t)0x00000000);
   
  SAI_FrameInitStruct->SAI_FSPolarity = ((uint32_t)0x00000000);
   
  SAI_FrameInitStruct->SAI_FSOffset = ((uint32_t)0x00000000);
}
...
void SAI_SlotStructInit(SAI_SlotInitTypeDef* SAI_SlotInitStruct)
{
  ...
  SAI_SlotInitStruct->SAI_SlotSize = ((uint32_t)0x00000000);
   
  SAI_SlotInitStruct->SAI_SlotNumber = 1;
   
  SAI_SlotInitStruct->SAI_SlotActive = ((uint32_t)0x00000000);
...
void SAI_Cmd(SAI_Block_TypeDef* SAI_Block_x, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    SAI_Block_x->CR1 |= ((uint32_t)0x00010000);
  }
  else
  {
...
void SAI_MonoModeConfig(SAI_Block_TypeDef* SAI_Block_x, uint32_t SAI_Mono_StreoMode)
{
  ...
  SAI_Block_x->CR1 &= ~(((uint32_t)0x00001000));
   
  SAI_Block_x->CR1 |= ((uint32_t)((uint32_t)0x00001000));
}
...
void SAI_CompandingModeConfig(SAI_Block_TypeDef* SAI_Block_x, uint32_t SAI_CompandingMode)
{
  ...
  SAI_Block_x->CR2 &= ~(((uint32_t)0x0000C000));
...
void SAI_MuteModeCmd(SAI_Block_TypeDef* SAI_Block_x, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    SAI_Block_x->CR2 |= ((uint32_t)0x00000020);
  }
  else
  {
...
void SAI_MuteValueConfig(SAI_Block_TypeDef* SAI_Block_x, uint32_t SAI_MuteValue)
{
  ...
  SAI_Block_x->CR2 &= ~(((uint32_t)0x00000040));
...
void SAI_MuteFrameCounterConfig(SAI_Block_TypeDef* SAI_Block_x, uint32_t SAI_MuteCounter)
{
  ...
  SAI_Block_x->CR2 &= ~(((uint32_t)0x00001F80));
   
  SAI_Block_x->CR2 |= (SAI_MuteCounter << 7);
}
#line 687 "STM_Lib\\src\\stm32f4xx_sai.c"
...
void SAI_FlushFIFO(SAI_Block_TypeDef* SAI_Block_x)
{
  ...
  SAI_Block_x->CR2 |= ((uint32_t)0x00000008);
}
...
void SAI_DMACmd(SAI_Block_TypeDef* SAI_Block_x, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    SAI_Block_x->CR1 |= ((uint32_t)0x00020000);
  }
  else
  {
...
FunctionalState SAI_GetCmdStatus(SAI_Block_TypeDef* SAI_Block_x)
{
  ...
  ((void)0);
  if ((SAI_Block_x->CR1 & (uint32_t)((uint32_t)0x00010000)) != 0)
  {
...
uint32_t SAI_GetFIFOStatus(SAI_Block_TypeDef* SAI_Block_x)
{
  ...
  tmpreg = (uint32_t)((SAI_Block_x->SR & ((uint32_t)0x00070000)));
