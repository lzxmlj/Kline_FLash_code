#line 1 "STM_Lib\\src\\stm32f4xx_flash_ramfunc.c"
...
#line 1 ".\\STM_Lib\\inc\\stm32f4xx_flash_ramfunc.h"
...
#line 39 ".\\STM_Lib\\inc\\stm32f4xx_flash_ramfunc.h"
...
#line 81 ".\\STM_Lib\\inc\\stm32f4xx_flash_ramfunc.h"
 
 
 
void FLASH_FlashInterfaceCmd(FunctionalState NewState);
void FLASH_FlashSleepModeCmd(FunctionalState NewState);
...
#line 59 "STM_Lib\\src\\stm32f4xx_flash_ramfunc.c"
...
void FLASH_FlashInterfaceCmd(FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
    ...
    ((((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR) &= ~(((uint32_t)0x00200000)));
  }
  else
  {
...
void FLASH_FlashSleepModeCmd(FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
    ...
    ((((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR) |= (((uint32_t)0x00100000)));
  }
  else
  {
