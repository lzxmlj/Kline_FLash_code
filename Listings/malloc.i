...
__align(32) u8 mem1base[1*1];													
__align(32) u8 mem2base[2 *2] __attribute__((at(0X68000000)));					

__align(32) u8 mem3base[1 *1];

u16 mem1mapbase[1*1/1];													
u16 mem2mapbase[2 *2/2] __attribute__((at(0X68000000+2 *2)));	

u16 mem3mapbase[1 *1/1];

const u32 memtblsize[3]={1*1/1,2 *2/2,1 *1/1};	
const u32 memblksize[3]={1,2,1};					
const u32 memsize[3]={1*1,2 *2,1 *1};							
