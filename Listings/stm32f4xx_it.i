...
void CAN1_RX0_IRQHandler(void)
{
    ...
    RxMessage.ExtId=0x00;
	  RxMessage.RTR=((uint32_t)0x00000000);  
    RxMessage.IDE=((uint32_t)0x00000000);	 
    RxMessage.DLC=0;
    RxMessage.FMI=0;
	...
	for(i =0; i < 8; i++)
	{
    if((check_over == 0) && (start_load_data == 1))
		  VcRAM_Utilty[can_receive_data] = RxMessage.Data[i];
    else if((check_over == 1)&& (start_load_data == 1))
      VcRAM_Cal[can_receive_data] = RxMessage.Data[i];
    else if((check_over == 2)&& (start_load_data == 1))
		  VcRAM_Rom[can_receive_data] = RxMessage.Data[i];
...
void CAN2_RX1_IRQHandler(void)
{
   ...
   RxMessage.StdId=0x00;
    ...
    CAN_Receive(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6800)),((uint8_t)0x01), &RxMessage);	 
...
void CAN2_RX0_IRQHandler(void)
{
    ...
    if((check_over == 0) && (start_load_data == 1))
		  VcRAM_Utilty[can_receive_data] = RxMessage.Data[i];
    else if((check_over == 1)&& (start_load_data == 0)
      VcRAM_Cal[can_receive_data] = RxMessage.Data[i];
    else if((check_over == 2)&& (start_load_data == 0))
		  VcRAM_Rom[can_receive_data] = RxMessage.Data[i];
		can_receive_data++;
	}
...
{
   u16 i;
   if(TIM_GetITStatus(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)),((uint16_t)0x0002)) != RESET)
   {
     TIM_ClearITPendingBit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)),((uint16_t)0x0002));
     loop_enable = 1;
...
{
   u16 i;
   if(TIM_GetITStatus(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)),((uint16_t)0x0002)) != RESET)
   {
     TIM_ClearITPendingBit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)),((uint16_t)0x0002));
