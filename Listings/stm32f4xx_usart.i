#line 1 "STM_Lib\\src\\stm32f4xx_usart.c"
...
#line 424 ".\\STM_Lib\\inc\\stm32f4xx_usart.h"
...
#line 93 "STM_Lib\\src\\stm32f4xx_usart.c"
#line 94 "STM_Lib\\src\\stm32f4xx_usart.c"
...
void USART_DeInit(USART_TypeDef* USARTx)
{
  ...
  if (USARTx == ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000)))
  {
  ...
  {
    if (USARTx == ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x7C00)))
    { 
      RCC_APB1PeriphResetCmd(((uint32_t)0x80000000), ENABLE);
      RCC_APB1PeriphResetCmd(((uint32_t)0x80000000), DISABLE);
    }
  }
}
...
void USART_Init(USART_TypeDef* USARTx, USART_InitTypeDef* USART_InitStruct)
{
  ...
  tmpreg &= (uint32_t)~((uint32_t)((uint16_t)0x3000));
  ...
  tmpreg &= (uint32_t)~((uint32_t)((uint16_t)(((uint16_t)0x1000) | ((uint16_t)0x0400) | ((uint16_t)0x0200) | ((uint16_t)0x0008) | ((uint16_t)0x0004))));
  ...
  tmpreg &= (uint32_t)~((uint32_t)((uint16_t)(((uint16_t)0x0100) | ((uint16_t)0x0200))));
  ...
  if ((USARTx == ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))) || (USARTx == ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400))))
  {
  ...
  if ((USARTx->CR1 & ((uint16_t)0x8000)) != 0)
  {
...
void USART_ClockInit(USART_TypeDef* USARTx, USART_ClockInitTypeDef* USART_ClockInitStruct)
{
  ...
  tmpreg &= (uint32_t)~((uint32_t)((uint16_t)(((uint16_t)0x0800) | ((uint16_t)0x0400) | ((uint16_t)0x0200) | ((uint16_t)0x0100))));
...
void USART_Cmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR1 &= (uint16_t)~((uint16_t)((uint16_t)0x2000));
  }
}
...
void USART_OverSampling8Cmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    USARTx->CR1 |= ((uint16_t)0x8000);
  }
  else
  {
     
    USARTx->CR1 &= (uint16_t)~((uint16_t)((uint16_t)0x8000));
  }
}  
...
void USART_OneBitMethodCmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    USARTx->CR3 |= ((uint16_t)0x0800);
  }
  else
  {
     
    USARTx->CR3 &= (uint16_t)~((uint16_t)((uint16_t)0x0800));
  }
}
...
void USART_SetAddress(USART_TypeDef* USARTx, uint8_t USART_Address)
{
  ...
  USARTx->CR2 &= (uint16_t)~((uint16_t)((uint16_t)0x000F));
...
void USART_ReceiverWakeUpCmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR1 &= (uint16_t)~((uint16_t)((uint16_t)0x0002));
  }
}
...
void USART_WakeUpConfig(USART_TypeDef* USARTx, uint16_t USART_WakeUp)
{
  ...
  USARTx->CR1 &= (uint16_t)~((uint16_t)((uint16_t)0x0800));
...
void USART_LINBreakDetectLengthConfig(USART_TypeDef* USARTx, uint16_t USART_LINBreakDetectLength)
{
  ...
  USARTx->CR2 &= (uint16_t)~((uint16_t)((uint16_t)0x0020));
...
void USART_LINCmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR2 &= (uint16_t)~((uint16_t)((uint16_t)0x4000));
  }
}
...
void USART_HalfDuplexCmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR3 &= (uint16_t)~((uint16_t)((uint16_t)0x0008));
  }
}
...
void USART_SmartCardCmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR3 &= (uint16_t)~((uint16_t)((uint16_t)0x0020));
  }
}
...
void USART_SmartCardNACKCmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR3 &= (uint16_t)~((uint16_t)((uint16_t)0x0010));
  }
}
...
void USART_IrDAConfig(USART_TypeDef* USARTx, uint16_t USART_IrDAMode)
{
  ...
  USARTx->CR3 &= (uint16_t)~((uint16_t)((uint16_t)0x0004));
...
void USART_IrDACmd(USART_TypeDef* USARTx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    USARTx->CR3 &= (uint16_t)~((uint16_t)((uint16_t)0x0002));
  }
}
