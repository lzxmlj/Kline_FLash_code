#line 1 "STM_Lib\\src\\stm32f4xx_spi.c"
...
#line 540 ".\\STM_Lib\\inc\\stm32f4xx_spi.h"
...
#line 160 "STM_Lib\\src\\stm32f4xx_spi.c"
#line 161 "STM_Lib\\src\\stm32f4xx_spi.c"
...
void SPI_I2S_DeInit(SPI_TypeDef* SPIx)
{
  ...
  if (SPIx == ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)))
  {
  ...
  else if (SPIx == ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)))
  {
  ...
  else if (SPIx == ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3400)))
  {
  ...
  else if (SPIx == ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x5000)))
  {
  ...
  {
    if (SPIx == ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x5400)))
    {
...
void SPI_Init(SPI_TypeDef* SPIx, SPI_InitTypeDef* SPI_InitStruct)
{
  ...
  SPIx->I2SCFGR &= (uint16_t)~((uint16_t)((uint16_t)0x0800));
...
#line 409 "STM_Lib\\src\\stm32f4xx_spi.c"
     
    if ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CFGR & ((uint32_t)0x00800000)) != 0)
    {
      ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CFGR &= ~(uint32_t)((uint32_t)0x00800000);
    }    
    
     
    plln = (uint32_t)(((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->PLLI2SCFGR & ((uint32_t)0x00007FC0)) >> 6) &                       (((uint32_t)0x00007FC0) >> 6));

    
     
    pllr = (uint32_t)(((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->PLLI2SCFGR & ((uint32_t)0x70000000)) >> 28) &                       (((uint32_t)0x70000000) >> 28));

    
     
    pllm = (uint32_t)(((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->PLLCFGR & ((uint32_t)0x0000003F));

    if((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->PLLCFGR & ((uint32_t)0x00400000)) == ((uint32_t)0x00400000))
    {
       
      i2sclk = (uint32_t)(((((uint32_t)25000000) / pllm) * plln) / pllr);
    }
    else
    {  
      i2sclk = (uint32_t)(((((uint32_t)16000000) / pllm) * plln) / pllr);
    }
  ...
  tmpreg |= (uint16_t)((uint16_t)((uint16_t)0x0800) | (uint16_t)(I2S_InitStruct->I2S_Mode |                   (uint16_t)(I2S_InitStruct->I2S_Standard | (uint16_t)(I2S_InitStruct->I2S_DataFormat |                   (uint16_t)I2S_InitStruct->I2S_CPOL))));


 
#line 485 "STM_Lib\\src\\stm32f4xx_spi.c"
...
void SPI_Cmd(SPI_TypeDef* SPIx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    SPIx->CR1 &= (uint16_t)~((uint16_t)((uint16_t)0x0040));
  }
}
...
void I2S_Cmd(SPI_TypeDef* SPIx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    SPIx->I2SCFGR &= (uint16_t)~((uint16_t)((uint16_t)0x0400));
  }
}
...
void SPI_SSOutputCmd(SPI_TypeDef* SPIx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    SPIx->CR2 |= (uint16_t)((uint8_t)0x04);
  }
  else
  {
     
    SPIx->CR2 &= (uint16_t)~((uint16_t)((uint8_t)0x04));
  }
}
...
void SPI_TIModeCmd(SPI_TypeDef* SPIx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    SPIx->CR2 |= ((uint16_t)0x0010);
  }
  else
  {
     
    SPIx->CR2 &= (uint16_t)~((uint16_t)0x0010);
  }
}
...
void I2S_FullDuplexConfig(SPI_TypeDef* I2Sxext, I2S_InitTypeDef* I2S_InitStruct)
{
  ...
  I2Sxext->I2SCFGR &= ((uint16_t)0xF040); 
  ...
  if ((I2S_InitStruct->I2S_Mode == ((uint16_t)0x0200)) || (I2S_InitStruct->I2S_Mode == ((uint16_t)0x0000)))
  {
    tmp = ((uint16_t)0x0100);
  }
  else
  {
    if ((I2S_InitStruct->I2S_Mode == ((uint16_t)0x0300)) || (I2S_InitStruct->I2S_Mode == ((uint16_t)0x0100)))
    {
      tmp = ((uint16_t)0x0000);
    }
  }
  ...
  tmpreg |= (uint16_t)((uint16_t)((uint16_t)0x0800) | (uint16_t)(tmp |                   (uint16_t)(I2S_InitStruct->I2S_Standard | (uint16_t)(I2S_InitStruct->I2S_DataFormat |                   (uint16_t)I2S_InitStruct->I2S_CPOL))));
...
void SPI_CalculateCRC(SPI_TypeDef* SPIx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    SPIx->CR1 &= (uint16_t)~((uint16_t)((uint16_t)0x2000));
  }
}
