#line 1 "STM_Lib\\src\\stm32f4xx_fsmc.c"
...
#line 667 ".\\STM_Lib\\inc\\stm32f4xx_fsmc.h"
...
#line 36 "STM_Lib\\src\\stm32f4xx_fsmc.c"
#line 37 "STM_Lib\\src\\stm32f4xx_fsmc.c"
...
{ 
  ...
  tmpbcr = ((FSMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[FSMC_NORSRAMInitStruct->FSMC_Bank];

  
 
  tmpbcr &= ((uint32_t)~(((uint32_t)0x00000001)    | ((uint32_t)0x00000002)    | ((uint32_t)0x0000000C)     |                          ((uint32_t)0x00000030)      | ((uint32_t)0x00000040)   | ((uint32_t)0x00000100)  |                          ((uint32_t)0x00000200)   | ((uint32_t)0x00000400)  | ((uint32_t)0x00000800)  |                          ((uint32_t)0x00001000)      | ((uint32_t)0x00002000)   | ((uint32_t)0x00004000)   |                          ((uint32_t)0x00008000) | ((uint32_t)0x00080000)));
  ...
  ((FSMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[FSMC_NORSRAMInitStruct->FSMC_Bank] = tmpbcr;
  ...
  tmpbtr = ((FSMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[FSMC_NORSRAMInitStruct->FSMC_Bank+1];

   
  tmpbtr &= ((uint32_t)~(((uint32_t)0x0000000F) | ((uint32_t)0x000000F0) | ((uint32_t)0x0000FF00) |                        ((uint32_t)0x000F0000) | ((uint32_t)0x00F00000) | ((uint32_t)0x0F000000) |                        ((uint32_t)0x30000000)));
  ...
  ((FSMC_Bank1_TypeDef *) (((uint32_t)0xA0000000) + 0x0000))->BTCR[FSMC_NORSRAMInitStruct->FSMC_Bank+1] = tmpbtr;
  ...
  if(FSMC_NORSRAMInitStruct->FSMC_ExtendedMode == ((uint32_t)0x00004000))
  {
    ...
    tmpbwr = ((FSMC_Bank1E_TypeDef *) (((uint32_t)0xA0000000) + 0x0104))->BWTR[FSMC_NORSRAMInitStruct->FSMC_Bank];
    
     
    tmpbwr &= ((uint32_t)~(((uint32_t)0x0000000F) | ((uint32_t)0x000000F0) | ((uint32_t)0x0000FF00) |                            ((uint32_t)0x000F0000) | ((uint32_t)0x30000000)));
    ...
    ((FSMC_Bank1E_TypeDef *) (((uint32_t)0xA0000000) + 0x0104))->BWTR[FSMC_NORSRAMInitStruct->FSMC_Bank] = tmpbwr;
  }
  else
  {
...
void FSMC_NANDInit(FSMC_NANDInitTypeDef* FSMC_NANDInitStruct)
{
  ...
  if(FSMC_NANDInitStruct->FSMC_Bank == ((uint32_t)0x00000010))
  {
    ...
    tmppcr = ((FSMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->PCR2;
  }
  else
  {
   
    tmppcr = ((FSMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->PCR3;
  }

   
  tmppcr &= ((uint32_t)~(((uint32_t)0x00000002)  | ((uint32_t)0x00000004) | ((uint32_t)0x00000008) |                          ((uint32_t)0x00000030) | ((uint32_t)0x00000040) | ((uint32_t)0x00001E00) |                          ((uint32_t)0x0001E000) | ((uint32_t)0x000E0000)));  
  ...
  if(FSMC_NANDInitStruct->FSMC_Bank == ((uint32_t)0x00000010))
  {
    ...
    tmppmem = ((FSMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->PMEM2;
  }
  else
  {
     
    tmppmem = ((FSMC_Bank3_TypeDef *) (((uint32_t)0xA0000000) + 0x0080))->PMEM3;
  } 
  
   
  tmppmem &= ((uint32_t)~(((uint32_t)0x000000FF)  | ((uint32_t)0x0000FF00) | ((uint32_t)0x00FF0000) |                           ((uint32_t)0xFF000000)));
  ...
  if(FSMC_NANDInitStruct->FSMC_Bank == ((uint32_t)0x00000010))
  {
    ...
    tmppatt = ((FSMC_Bank2_TypeDef *) (((uint32_t)0xA0000000) + 0x0060))->PATT2;
  }
  else
  {
  ...
  tmppatt &= ((uint32_t)~(((uint32_t)0x000000FF)  | ((uint32_t)0x0000FF00) | ((uint32_t)0x00FF0000) |                           ((uint32_t)0xFF000000)));
...
void FSMC_PCCARDInit(FSMC_PCCARDInitTypeDef* FSMC_PCCARDInitStruct)
{
  ...
  tmppcr4 = ((FSMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PCR4;
  
   
  tmppcr4 &= ((uint32_t)~(((uint32_t)0x0001E000)  | ((uint32_t)0x00001E00) | ((uint32_t)0x00000002) |                           ((uint32_t)0x00000030)));
  ...
  ((FSMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PCR4 = tmppcr4;
  
   
  tmppmem4 = ((FSMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PMEM4;
  
   
  tmppmem4 &= ((uint32_t)~(((uint32_t)0x000000FF)  | ((uint32_t)0x0000FF00) | ((uint32_t)0x00FF0000) |                            ((uint32_t)0xFF000000)));
  ...
  ((FSMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PMEM4 = tmppmem4;
  
   
  tmppatt4 = ((FSMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PATT4;

   
  tmppatt4 &= ((uint32_t)~(((uint32_t)0x000000FF)  | ((uint32_t)0x0000FF00) | ((uint32_t)0x00FF0000) |                            ((uint32_t)0xFF000000)));
  ...
  ((FSMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PATT4 = tmppatt4;

   
  tmppio4 = ((FSMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PIO4;

   
  tmppio4 &= ((uint32_t)~(((uint32_t)0x000000FF)  | ((uint32_t)0x0000FF00) | ((uint32_t)0x00FF0000) |                           ((uint32_t)0xFF000000)));
  ...
  ((FSMC_Bank4_TypeDef *) (((uint32_t)0xA0000000) + 0x00A0))->PIO4 = tmppio4;					 
}
