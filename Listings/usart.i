...
{      
	...
	((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->DR = (u8) ch;      
	return ch;
}
...
void USART1_IRQHandler(void)
{
	...
	if(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->SR&(1<<5))
	{	 
		res=((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->DR; 
...
{  	 
    ...
    mantissa<<=4;
	mantissa+=fraction; 
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1ENR|=1<<0;   	
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB2ENR|=1<<4;  	
	GPIO_Set(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)),1<<9|1<<10,2,0,2,1);
 	GPIO_AF_Set(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)),9,7);	
	GPIO_AF_Set(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)),10,7);
	
 	((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->BRR=mantissa; 	
	((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->CR1&=~(1<<15); 	
	((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->CR1|=1<<3;  	

	
	((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->CR1|=1<<2;  	
	((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->CR1|=1<<5;    	
	MY_NVIC_Init(3,3,USART1_IRQn,2);

	((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->CR1|=1<<13;  	
}
