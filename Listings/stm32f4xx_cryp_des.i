#line 1 "STM_Lib\\src\\stm32f4xx_cryp_des.c"
...
#line 49 "STM_Lib\\src\\stm32f4xx_cryp_des.c"
                         ...
                         uint32_t Ilength, uint8_t *Output)
{
  ...
  {
     DES_CRYP_InitStructure.CRYP_AlgoDir  = ((uint16_t)0x0000);
  }
  else   
  {      
     DES_CRYP_InitStructure.CRYP_AlgoDir  = ((uint16_t)0x0004);
  }

  DES_CRYP_InitStructure.CRYP_AlgoMode = ((uint32_t)0x00000010);
  DES_CRYP_InitStructure.CRYP_DataType = ((uint16_t)0x0080);
                         ...
                         uint8_t *Input, uint32_t Ilength, uint8_t *Output)
{
  ...
  DES_CRYP_InitStructure.CRYP_AlgoMode = ((uint32_t)0x00000018);
  DES_CRYP_InitStructure.CRYP_DataType = ((uint16_t)0x0080);
  CRYP_Init(&DES_CRYP_InitStructure);
