#line 1 "STM_Lib\\src\\stm32f4xx_hash_md5.c"
...
#line 48 "STM_Lib\\src\\stm32f4xx_hash_md5.c"
...
ErrorStatus HASH_MD5(uint8_t *Input, uint32_t Ilen, uint8_t Output[16])
{
  ...
  MD5_HASH_InitStructure.HASH_AlgoSelection = ((uint32_t)0x00000080);
  MD5_HASH_InitStructure.HASH_AlgoMode = ((uint32_t)0x00000000);
  MD5_HASH_InitStructure.HASH_DataType = ((uint32_t)0x00000020);
                     ...
                     uint32_t Ilen, uint8_t Output[16])
{
  ...
  MD5_HASH_InitStructure.HASH_AlgoSelection = ((uint32_t)0x00000080);
  MD5_HASH_InitStructure.HASH_AlgoMode = ((uint32_t)0x00000040);
  MD5_HASH_InitStructure.HASH_DataType = ((uint32_t)0x00000020);
  if(Keylen > 64)
  {
     
    MD5_HASH_InitStructure.HASH_HMACKeyType = ((uint32_t)0x00010000);
  }
  else
  {
     
    MD5_HASH_InitStructure.HASH_HMACKeyType = ((uint32_t)0x00000000);
  }
  HASH_Init(&MD5_HASH_InitStructure);
