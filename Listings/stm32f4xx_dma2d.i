#line 1 "STM_Lib\\src\\stm32f4xx_dma2d.c"
...
#line 1 ".\\STM_Lib\\inc\\stm32f4xx_dma2d.h"
...
#line 39 ".\\STM_Lib\\inc\\stm32f4xx_dma2d.h"
...
#line 294 ".\\STM_Lib\\inc\\stm32f4xx_dma2d.h"

#line 301 ".\\STM_Lib\\inc\\stm32f4xx_dma2d.h"

#line 308 ".\\STM_Lib\\inc\\stm32f4xx_dma2d.h"
...
#line 382 ".\\STM_Lib\\inc\\stm32f4xx_dma2d.h"
...
#line 401 ".\\STM_Lib\\inc\\stm32f4xx_dma2d.h"
...
#line 59 "STM_Lib\\src\\stm32f4xx_dma2d.c"
#line 60 "STM_Lib\\src\\stm32f4xx_dma2d.c"
...
void DMA2D_DeInit(void)
{
  ...
  RCC_AHB1PeriphResetCmd(((uint32_t)0x00800000), ENABLE);
   
  RCC_AHB1PeriphResetCmd(((uint32_t)0x00800000), DISABLE);
}
...
void DMA2D_Init(DMA2D_InitTypeDef* DMA2D_InitStruct)
{
  ...
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->CR &= (uint32_t)((uint32_t)0xFFFCE0FC);
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->CR |= (DMA2D_InitStruct->DMA2D_Mode);

   
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->OPFCCR &= ~(uint32_t)((uint32_t)0x00000007);
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->OPFCCR |= (DMA2D_InitStruct->DMA2D_CMode);

   

  if (DMA2D_InitStruct->DMA2D_CMode == ((uint32_t)0x00000000))
  {
    ...
    if (DMA2D_InitStruct->DMA2D_CMode == ((uint32_t)0x00000001))
    {
      outgreen = DMA2D_InitStruct->DMA2D_OutputGreen << 8;
      outred = DMA2D_InitStruct->DMA2D_OutputRed << 16;
    ...
    if (DMA2D_InitStruct->DMA2D_CMode == ((uint32_t)0x00000002))
    {
    ...
    if (DMA2D_InitStruct->DMA2D_CMode == ((uint32_t)0x00000003))
    {  
      outgreen = DMA2D_InitStruct->DMA2D_OutputGreen << 5;
  ...
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->OCOLR |= ((outgreen) | (outred) | (DMA2D_InitStruct->DMA2D_OutputBlue) | (outalpha));

   
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->OMAR = (DMA2D_InitStruct->DMA2D_OutputMemoryAdd);

   
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->OOR &= ~(uint32_t)((uint32_t)0x00003FFF);
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->OOR |= (DMA2D_InitStruct->DMA2D_OutputOffset);

   
  pixline = DMA2D_InitStruct->DMA2D_PixelPerLine << 16; 
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->NLR &= ~(((uint32_t)0x0000FFFF) | ((uint32_t)0x3FFF0000));
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->NLR |= ((DMA2D_InitStruct->DMA2D_NumberOfLine) | (pixline));
...
void DMA2D_StructInit(DMA2D_InitTypeDef* DMA2D_InitStruct)
{
  ...
  DMA2D_InitStruct->DMA2D_Mode = ((uint32_t)0x00000000);

   
  DMA2D_InitStruct->DMA2D_CMode = ((uint32_t)0x00000000);
...
void DMA2D_StartTransfer(void)
{
    ...
    ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->CR |= (uint32_t)((uint32_t)0x00000001);
}
...
void DMA2D_AbortTransfer(void)
{
    ...
    ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->CR |= (uint32_t)((uint32_t)0x00000004);
...
void DMA2D_Suspend(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->CR |= (uint32_t)((uint32_t)0x00000002);
  }
  else
  {
...
void DMA2D_FGConfig(DMA2D_FG_InitTypeDef* DMA2D_FG_InitStruct)
{
  ...
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->FGMAR = (DMA2D_FG_InitStruct->DMA2D_FGMA);

   
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->FGOR &= ~(uint32_t)((uint32_t)0x00003FFF);
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->FGOR |= (DMA2D_FG_InitStruct->DMA2D_FGO);

   
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->FGPFCCR &= (uint32_t)((uint32_t)0x00FC00C0);
  ...
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->FGPFCCR |= (DMA2D_FG_InitStruct->DMA2D_FGCM | fg_clutcolormode | fg_clutsize |                     fg_alpha_mode | fg_alphavalue);


   
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->FGCOLR &= ~(((uint32_t)0x000000FF) | ((uint32_t)0x0000FF00) | ((uint32_t)0x00FF0000));
  fg_colorgreen = DMA2D_FG_InitStruct->DMA2D_FGC_GREEN << 8;
  fg_colorred = DMA2D_FG_InitStruct->DMA2D_FGC_RED << 16;
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->FGCOLR |= (DMA2D_FG_InitStruct->DMA2D_FGC_BLUE | fg_colorgreen | fg_colorred);

   
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->FGCMAR = DMA2D_FG_InitStruct->DMA2D_FGCMAR;
}
...
void DMA2D_FG_StructInit(DMA2D_FG_InitTypeDef* DMA2D_FG_InitStruct)
{
  ...
  DMA2D_FG_InitStruct->DMA2D_FGCM = ((uint32_t)0x00000000);

   
  DMA2D_FG_InitStruct->DMA2D_FG_CLUT_CM = ((uint32_t)0x00000000);

   
  DMA2D_FG_InitStruct->DMA2D_FG_CLUT_SIZE = 0x00;

   
  DMA2D_FG_InitStruct->DMA2D_FGPFC_ALPHA_MODE = ((uint32_t)0x00000000);
...
void DMA2D_BGConfig(DMA2D_BG_InitTypeDef* DMA2D_BG_InitStruct)
{
  ...
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->BGMAR = (DMA2D_BG_InitStruct->DMA2D_BGMA);

   
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->BGOR &= ~(uint32_t)((uint32_t)0x00003FFF);
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->BGOR |= (DMA2D_BG_InitStruct->DMA2D_BGO);

   
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->BGPFCCR &= (uint32_t)((uint32_t)0x00FC00C0);
  ...
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->BGPFCCR |= (DMA2D_BG_InitStruct->DMA2D_BGCM | bg_clutcolormode | bg_clutsize |                     bg_alpha_mode | bg_alphavalue);


   
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->BGCOLR &= ~(((uint32_t)0x000000FF) | ((uint32_t)0x0000FF00) | ((uint32_t)0x00FF0000));
  bg_colorgreen = DMA2D_BG_InitStruct->DMA2D_BGC_GREEN << 8;
  bg_colorred = DMA2D_BG_InitStruct->DMA2D_BGC_RED << 16;
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->BGCOLR |= (DMA2D_BG_InitStruct->DMA2D_BGC_BLUE | bg_colorgreen | bg_colorred);
  
   
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->BGCMAR = DMA2D_BG_InitStruct->DMA2D_BGCMAR;
...
void DMA2D_BG_StructInit(DMA2D_BG_InitTypeDef* DMA2D_BG_InitStruct)
{
  ...
  DMA2D_BG_InitStruct->DMA2D_BGCM = ((uint32_t)0x00000000);

   
  DMA2D_BG_InitStruct->DMA2D_BG_CLUT_CM = ((uint32_t)0x00000000);

   
  DMA2D_BG_InitStruct->DMA2D_BG_CLUT_SIZE = 0x00;

   
  DMA2D_BG_InitStruct->DMA2D_BGPFC_ALPHA_MODE = ((uint32_t)0x00000000);
...
void DMA2D_FGStart(FunctionalState NewState) 
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->FGPFCCR |= ((uint32_t)0x00000020);
  }
  else
  {
     
    ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->FGPFCCR &= (uint32_t)~((uint32_t)0x00000020);
  }
}
...
void DMA2D_BGStart(FunctionalState NewState) 
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->BGPFCCR |= ((uint32_t)0x00000020);
  }
  else
  {
     
    ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->BGPFCCR &= (uint32_t)~((uint32_t)0x00000020);
  }
}
...
void DMA2D_DeadTimeConfig(uint32_t DMA2D_DeadTime, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->AMTCR &= (uint32_t)((uint32_t)0xFFFF00FE);
    DeadTime = DMA2D_DeadTime << 8;
    ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->AMTCR |= (DeadTime | ((uint32_t)0x00000001));
  }
  else
  {
     ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->AMTCR &= ~(uint32_t)((uint32_t)0x00000001);
  }
}
...
void DMA2D_LineWatermarkConfig(uint32_t DMA2D_LWatermarkConfig)
{
  ...
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->LWR = (uint32_t)DMA2D_LWatermarkConfig;
}
...
void DMA2D_ITConfig(uint32_t DMA2D_IT, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->CR |= DMA2D_IT;
  }
  else
  {
     
    ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->CR &= (uint32_t)~DMA2D_IT;
  }
}
...
FlagStatus DMA2D_GetFlagStatus(uint32_t DMA2D_FLAG)
{
  ...
  if (((((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->ISR) & DMA2D_FLAG) != (uint32_t)RESET)
  {
...
void DMA2D_ClearFlag(uint32_t DMA2D_FLAG)
{
  ...
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->IFCR = (uint32_t)DMA2D_FLAG;
}
...
ITStatus DMA2D_GetITStatus(uint32_t DMA2D_IT)
{
  ...
  if ((((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->ISR & DMA2D_IT_FLAG) != (uint32_t)RESET)
  {
    bitstatus = SET;
  }
  else
  ...
  if (((((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->CR & DMA2D_IT) != (uint32_t)RESET) && (bitstatus != (uint32_t)RESET))
  {
    bitstatus = SET;
  }
  else
...
void DMA2D_ClearITPendingBit(uint32_t DMA2D_IT)
{
  ...
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->IFCR = (uint32_t)DMA2D_IT;
}
