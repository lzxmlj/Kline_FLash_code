#line 1 "STM_Lib\\src\\stm32f4xx_hash_sha1.c"
...
#line 48 "STM_Lib\\src\\stm32f4xx_hash_sha1.c"
...
ErrorStatus HASH_SHA1(uint8_t *Input, uint32_t Ilen, uint8_t Output[20])
{
  ...
  volatile uint16_t nbvalidbitsdata = 0;
  uint32_t i = 0;
  ...
  SHA1_HASH_InitStructure.HASH_AlgoSelection = ((uint32_t)0x0000);
  SHA1_HASH_InitStructure.HASH_AlgoMode = ((uint32_t)0x00000000);
  SHA1_HASH_InitStructure.HASH_DataType = ((uint32_t)0x00000020);
  ...
  do
  {
    busystatus = HASH_GetFlagStatus(((uint32_t)0x00000008));
    counter++;
                      ...
                      uint32_t Ilen, uint8_t Output[20])
{
  ...
  HASH_MsgDigest SHA1_MessageDigest;
  volatile uint16_t nbvalidbitsdata = 0;
  volatile uint16_t nbvalidbitskey = 0;
  uint32_t i = 0;
  volatile uint32_t counter = 0;
  uint32_t busystatus = 0;
  ErrorStatus status = SUCCESS;
  ...
  SHA1_HASH_InitStructure.HASH_AlgoSelection = ((uint32_t)0x0000);
  SHA1_HASH_InitStructure.HASH_AlgoMode = ((uint32_t)0x00000040);
  SHA1_HASH_InitStructure.HASH_DataType = ((uint32_t)0x00000020);
  if(Keylen > 64)
  {
     
    SHA1_HASH_InitStructure.HASH_HMACKeyType = ((uint32_t)0x00010000);
  }
  else
  {
     
    SHA1_HASH_InitStructure.HASH_HMACKeyType = ((uint32_t)0x00000000);
  }
  HASH_Init(&SHA1_HASH_InitStructure);
