...
#line 123 ".\\USER\\stm32f4xx_conf.h"
...
u8 CAN2_Mode_Init(u8 tsjw,u8 tbs2,u8 tbs1,u16 brp,u8 mode)
{
  	...
  	RCC_APB1PeriphClockCmd(((uint32_t)0x02000000)|((uint32_t)0x04000000), ENABLE); 
	
    
	  GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x1000)| ((uint16_t)0x2000);
    ...
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), &GPIO_InitStructure);
	  ...
	  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)),((uint8_t)0x0C),((uint8_t)0x09)); 
	  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)),((uint8_t)0x0D),((uint8_t)0x09)); 
  	...
  	CAN_Init(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6800)), &CAN_InitStructure);   
  	...
  	CAN_FilterInitStructure.CAN_FilterMaskIdLow=0x0000;
   	CAN_FilterInitStructure.CAN_FilterFIFOAssignment=((uint8_t)0x00);
...
void CAN1_Config(void)
   {
	...
	GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x1000) | ((uint16_t)0x0800);
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF;
   ...
   GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
    ...
    GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint8_t)0x0B), ((uint8_t)0x09));
    GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint8_t)0x0C), ((uint8_t)0x09));
    ...
    CAN_Init(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)),&CAN_InitStructure);   
	...
	CAN_ITConfig(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)),((uint32_t)0x00000002),ENABLE);  
...
void CAN2_Config(void)
{
	...
	RCC_AHB1PeriphClockCmd(((uint32_t)0x00000002), ENABLE);
	RCC_APB1PeriphClockCmd(((uint32_t)0x04000000), ENABLE);
   ...
   GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), &GPIO_InitStructure);								
    GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), ((uint8_t)0x05), ((uint8_t)0x09));
    GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), ((uint8_t)0x06), ((uint8_t)0x09)); 
	...
	CAN_DeInit(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6800)));
    ...
    CAN_FilterInitStructure.CAN_FilterMaskIdHigh=0x0000;		
    CAN_FilterInitStructure.CAN_FilterMaskIdLow=0x0000;
    CAN_FilterInitStructure.CAN_FilterFIFOAssignment=((uint8_t)0x01);	 
    CAN_FilterInitStructure.CAN_FilterActivation=ENABLE;
    CAN_FilterInit(&CAN_FilterInitStructure);

	CAN_ITConfig(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6800)),((uint32_t)0x00000010),ENABLE);  
}
void CAN_SendData(CAN_TypeDef* CANx,CanTxMsg* CanData)
{
	...
	while((mailbox==((uint8_t)0x04))&&(retrys<0xFE));
	retrys=0;
}
...
TestStatus CAN_Polling(void)
{
  ...
  TransmitMailbox = CAN_Transmit(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), &TxMessage);
  i = 0;
  while((CAN_TransmitStatus(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), TransmitMailbox)  !=  ((uint8_t)0x01)) && (i  !=  0xFFFF))
  {
    i++;
  }

  i = 0;
  while((CAN_MessagePending(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), ((uint8_t)0x00)) < 1) && (i  !=  0xFFFF))
  {
    i++;
  }
  ...
  RxMessage0.IDE = ((uint32_t)0x00000000);
  RxMessage0.DLC = 0;
  RxMessage0.Data[0] = 0x00;
  RxMessage0.Data[1] = 0x00;
  CAN_Receive(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), ((uint8_t)0x00), &RxMessage0);
  ...
  if (RxMessage0.IDE != ((uint32_t)0x00000000))
  {
    return FAILED;
  }
...
TestStatus CAN_Interrupt(void)
{
  ...
  TxMessage.StdId = 0;
  TxMessage.IDE = ((uint32_t)0x00000000);
  TxMessage.RTR = ((uint32_t)0x00000000);
  TxMessage.DLC = 2;
  TxMessage.Data[0] = 0xDE;
  TxMessage.Data[1] = 0xCA;
  CAN_Transmit(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), &TxMessage);
  ...
  CAN_ITConfig(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), ((uint32_t)0x00000002), DISABLE);
...
{	
  ...
  if( requested == 1)
  {
     TxMessage.StdId= can_message_id;	 
     TxMessage.IDE=0;		  
     TxMessage.RTR=0;		  
     TxMessage.DLC=8;							 
     for(i=0;i<8;i++)
     TxMessage.Data[i]=msg[i];				 
     mbox= CAN_Transmit(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), &TxMessage);   
     i=0;
     while((CAN_TransmitStatus(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), mbox)==((uint8_t)0x00))&&(i<0XFFF))i++;	
     if(i>=0XFFF)return 1;
     return 0;		
   }
}
...
{		   		   
 	u32 i;
    if( CAN_MessagePending(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)),((uint8_t)0x00))==0)return 0;		
    CAN_Receive(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), ((uint8_t)0x00), &RxMessage);
...
{		   		   
 	u32 i;
    if( CAN_MessagePending(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6800)),((uint8_t)0x00))==0)return 0;		
    CAN_Receive(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6800)), ((uint8_t)0x00), &RxMessage);
          for(i=0;i<RxMessage.DLC;i++)
          buf[i]=RxMessage.Data[i];  
	return RxMessage.DLC;	
}
