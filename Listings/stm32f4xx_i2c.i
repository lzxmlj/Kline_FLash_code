#line 1 "STM_Lib\\src\\stm32f4xx_i2c.c"
...
#line 700 ".\\STM_Lib\\inc\\stm32f4xx_i2c.h"
...
#line 93 "STM_Lib\\src\\stm32f4xx_i2c.c"
#line 94 "STM_Lib\\src\\stm32f4xx_i2c.c"
...
void I2C_DeInit(I2C_TypeDef* I2Cx)
{
  ...
  else if (I2Cx == ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5800)))
  {
  ...
  {
    if (I2Cx == ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5C00)))
    {
       
      RCC_APB1PeriphResetCmd(((uint32_t)0x00800000), ENABLE);
       
      RCC_APB1PeriphResetCmd(((uint32_t)0x00800000), DISABLE);     
    }
  }
}
...
void I2C_Init(I2C_TypeDef* I2Cx, I2C_InitTypeDef* I2C_InitStruct)
{
  ...
  tmpreg &= (uint16_t)~((uint16_t)((uint16_t)0x003F));
  ...
  I2Cx->CR1 &= (uint16_t)~((uint16_t)((uint16_t)0x0001));
...
void I2C_AnalogFilterCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->FLTR &= (uint16_t)~((uint16_t)((uint8_t)0x10));    
  }
  else
  {
     
    I2Cx->FLTR |= ((uint8_t)0x10);
  }
}
...
void I2C_DigitalFilterConfig(I2C_TypeDef* I2Cx, uint16_t I2C_DigitalFilter)
{
  ...
  tmpreg &= (uint16_t)~((uint16_t)((uint8_t)0x0F));
  
   
  tmpreg |= (uint16_t)((uint16_t)I2C_DigitalFilter & ((uint8_t)0x0F));
...
void I2C_GenerateSTART(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR1 &= (uint16_t)~((uint16_t)((uint16_t)0x0100));
  }
}
...
void I2C_GenerateSTOP(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR1 &= (uint16_t)~((uint16_t)((uint16_t)0x0200));
  }
}
...
void I2C_Send7bitAddress(I2C_TypeDef* I2Cx, uint8_t Address, uint8_t I2C_Direction)
{
  ...
  else
  {
    ...
    Address &= (uint8_t)~((uint8_t)((uint16_t)0x0001));
  }
...
void I2C_AcknowledgeConfig(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR1 &= (uint16_t)~((uint16_t)((uint16_t)0x0400));
  }
}
...
void I2C_OwnAddress2Config(I2C_TypeDef* I2Cx, uint8_t Address)
{
  ...
  tmpreg &= (uint16_t)~((uint16_t)((uint8_t)0xFE));
...
void I2C_DualAddressCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->OAR2 |= ((uint8_t)0x01);
  }
  else
  {
     
    I2Cx->OAR2 &= (uint16_t)~((uint16_t)((uint8_t)0x01));
  }
}
...
void I2C_GeneralCallCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR1 &= (uint16_t)~((uint16_t)((uint16_t)0x0040));
  }
}
...
void I2C_SoftwareResetCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR1 &= (uint16_t)~((uint16_t)((uint16_t)0x8000));
  }
}
...
void I2C_StretchClockCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR1 &= (uint16_t)~((uint16_t)((uint16_t)0x0080));
  }
}
...
void I2C_ARPCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR1 &= (uint16_t)~((uint16_t)((uint16_t)0x0010));
  }
}
...
void I2C_TransmitPEC(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR1 &= (uint16_t)~((uint16_t)((uint16_t)0x1000));
  }
}
...
void I2C_CalculatePEC(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR1 &= (uint16_t)~((uint16_t)((uint16_t)0x0020));
  }
}
...
void I2C_DMACmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR2 &= (uint16_t)~((uint16_t)((uint16_t)0x0800));
  }
}
...
void I2C_DMALastTransferCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->CR2 &= (uint16_t)~((uint16_t)((uint16_t)0x1000));
  }
}
