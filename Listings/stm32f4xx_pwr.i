...
#line 1 ".\\STM_Lib\\inc\\stm32f4xx_pwr.h"
...
#line 39 ".\\STM_Lib\\inc\\stm32f4xx_pwr.h"
...
#line 66 ".\\STM_Lib\\inc\\stm32f4xx_pwr.h"
...
#line 126 ".\\STM_Lib\\inc\\stm32f4xx_pwr.h"
...
#line 146 ".\\STM_Lib\\inc\\stm32f4xx_pwr.h"
...
#line 161 ".\\STM_Lib\\inc\\stm32f4xx_pwr.h"
...
#line 39 "STM_Lib\\src\\stm32f4xx_pwr.c"
#line 40 "STM_Lib\\src\\stm32f4xx_pwr.c"
...
#line 91 "STM_Lib\\src\\stm32f4xx_pwr.c"

#line 101 "STM_Lib\\src\\stm32f4xx_pwr.c"
...
#line 122 "STM_Lib\\src\\stm32f4xx_pwr.c"
...
#line 333 "STM_Lib\\src\\stm32f4xx_pwr.c"
...
void PWR_BackupRegulatorCmd(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x7000) - ((uint32_t)0x40000000)) + 0x04) * 32) + (0x09 * 4)) = (uint32_t)NewState;
}
...
void PWR_OverDriveCmd(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x7000) - ((uint32_t)0x40000000)) + 0x00) * 32) + (0x10 * 4)) = (uint32_t)NewState;
}
...
void PWR_OverDriveSWCmd(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x7000) - ((uint32_t)0x40000000)) + 0x00) * 32) + (0x11 * 4)) = (uint32_t)NewState;
}
...
void PWR_UnderDriveCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR |= (uint32_t)((uint32_t)0x000C0000);
  }
  else
  {
...
#line 591 "STM_Lib\\src\\stm32f4xx_pwr.c"

#line 641 "STM_Lib\\src\\stm32f4xx_pwr.c"
...
void PWR_FlashPowerDownCmd(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x7000) - ((uint32_t)0x40000000)) + 0x00) * 32) + (0x09 * 4)) = (uint32_t)NewState;
}
...
void PWR_EnterSTANDBYMode(void)
{
  ...
  ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR |= ((uint32_t)0x00000002);
...
#line 1031 "STM_Lib\\src\\stm32f4xx_pwr.c"
