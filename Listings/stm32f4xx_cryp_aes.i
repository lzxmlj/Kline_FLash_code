#line 1 "STM_Lib\\src\\stm32f4xx_cryp_aes.c"
...
#line 375 ".\\STM_Lib\\inc\\stm32f4xx_cryp.h"
...
#line 56 "STM_Lib\\src\\stm32f4xx_cryp_aes.c"
                         ...
                         uint8_t* Input, uint32_t Ilength, uint8_t* Output)
{
  ...
  {
    case 128:
    AES_CRYP_InitStructure.CRYP_KeySize = ((uint16_t)0x0000);
    ...
    break;
    case 192:
    AES_CRYP_InitStructure.CRYP_KeySize  = ((uint16_t)0x0100);
    ...
    break;
    case 256:
    AES_CRYP_InitStructure.CRYP_KeySize  = ((uint16_t)0x0200);
  ...
  if(Mode == ((uint8_t)0x00))  
  {
    ...
    AES_CRYP_InitStructure.CRYP_AlgoDir = ((uint16_t)0x0004);
    AES_CRYP_InitStructure.CRYP_AlgoMode = ((uint32_t)0x00000038);
    AES_CRYP_InitStructure.CRYP_DataType = ((uint16_t)0x0000);
    ...
    do
    {
      busystatus = CRYP_GetFlagStatus(((uint8_t)0x10));
      counter++;
    }while ((counter != ((uint32_t) 0x00010000)) && (busystatus != RESET));
  ...
  else  
  {
    ...
    AES_CRYP_InitStructure.CRYP_AlgoDir  = ((uint16_t)0x0000);
  }

  AES_CRYP_InitStructure.CRYP_AlgoMode = ((uint32_t)0x00000020);
  AES_CRYP_InitStructure.CRYP_DataType = ((uint16_t)0x0080);
  CRYP_Init(&AES_CRYP_InitStructure);
                         ...
                         uint8_t *Output)
{
  ...
  AES_CRYP_InitStructure.CRYP_AlgoMode = ((uint32_t)0x00000028);
  AES_CRYP_InitStructure.CRYP_DataType = ((uint16_t)0x0080);
  CRYP_Init(&AES_CRYP_InitStructure);
                         ...
                         uint8_t *Output)
{
  ...
  AES_CRYP_InitStructure.CRYP_AlgoMode = ((uint32_t)0x00000030);
  AES_CRYP_InitStructure.CRYP_DataType = ((uint16_t)0x0080);
  CRYP_Init(&AES_CRYP_InitStructure);
                         ...
                         uint8_t *Output, uint8_t *AuthTAG)
{
  ...
  if(Mode == ((uint8_t)0x01))  
  {
    ...
    AES_CRYP_InitStructure.CRYP_AlgoDir = ((uint16_t)0x0000);
    AES_CRYP_InitStructure.CRYP_AlgoMode = ((uint32_t)0x00080000);
    AES_CRYP_InitStructure.CRYP_DataType = ((uint16_t)0x0080);
    CRYP_Init(&AES_CRYP_InitStructure);
    
     
     
    CRYP_PhaseConfig(((uint32_t)0x00000000));
    ...
    if(HLength != 0)
    {
      ...
      CRYP_PhaseConfig(((uint32_t)0x00010000));
      ...
      for(loopcounter = 0; (loopcounter < HLength); loopcounter+=16)
      {
        ...
        while(CRYP_GetFlagStatus(((uint8_t)0x01)) == RESET)
        {
        }
    ...
    if(ILength != 0)
    {
      ...
      CRYP_PhaseConfig(((uint32_t)0x00020000));
      ...
      for(loopcounter = 0; ((loopcounter < ILength) && (status != ERROR)); loopcounter+=16)
      {
        ...
        else
        {
          ...
          while(CRYP_GetFlagStatus(((uint8_t)0x04)) == RESET)
          {
          }
    ...
    CRYP_PhaseConfig(((uint32_t)0x00030000));
                         ...
                         uint8_t *AuthTAG, uint32_t TAGSize)
{
  ...
  if(Mode == ((uint8_t)0x01))  
  {
    ...
    AES_CRYP_InitStructure.CRYP_AlgoDir = ((uint16_t)0x0000);
    AES_CRYP_InitStructure.CRYP_AlgoMode = ((uint32_t)0x00080008);
    AES_CRYP_InitStructure.CRYP_DataType = ((uint16_t)0x0080);
    CRYP_Init(&AES_CRYP_InitStructure);
